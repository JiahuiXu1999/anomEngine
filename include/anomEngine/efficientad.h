#ifndef ANOM_ENGINE_EFFICIENTAD_H
#define ANOM_ENGINE_EFFICIENTAD_H
...
typedef struct anom_efficientad anom_efficientad_t;

/*
 * Zero-initialize, set struct_size = sizeof(object), then call anom_efficientad_init.
...
struct anom_efficientad {
    ...
    anom_status_t (ANOM_CALL *load)(
        anom_efficientad_t* self, const char* model_package_utf8, const anom_algorithm_options_t* options);
    void (ANOM_CALL *release)(
        anom_efficientad_t* self);
    ...
    anom_status_t (ANOM_CALL *predict)(
        anom_efficientad_t* self, const anom_image_t* image, anom_prediction_t* out_prediction);
    anom_status_t (ANOM_CALL *predict_batch)(
        anom_efficientad_t* self, const anom_image_t* images, size_t image_count, anom_prediction_t* out_predictions);
};
