#ifndef ANOM_ENGINE_SPADE_H
#define ANOM_ENGINE_SPADE_H
...
typedef struct anom_spade anom_spade_t;

/*
 * Zero-initialize, set struct_size = sizeof(object), then call anom_spade_init.
...
struct anom_spade {
    ...
    anom_status_t (ANOM_CALL *load)(
        anom_spade_t* self, const char* model_package_utf8, const anom_algorithm_options_t* options);
    ...
    anom_status_t (ANOM_CALL *predict)(
        anom_spade_t* self, const anom_image_t* image, anom_prediction_t* out_prediction);
    anom_status_t (ANOM_CALL *predict_batch)(
        anom_spade_t* self, const anom_image_t* images, size_t image_count, anom_prediction_t* out_predictions);
};
