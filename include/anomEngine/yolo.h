#ifndef ANOM_ENGINE_YOLO_H
#define ANOM_ENGINE_YOLO_H
...
typedef struct anom_yolo anom_yolo_t;

/*
 * Zero-initialize, set struct_size = sizeof(object), then call anom_yolo_init.
...
struct anom_yolo {
    ...
    anom_status_t (ANOM_CALL *load)(
        anom_yolo_t* self, const char* model_package_utf8, const anom_algorithm_options_t* options);
    ...
    anom_status_t (ANOM_CALL *predict)(
        anom_yolo_t* self, const anom_image_t* image, anom_prediction_t* out_prediction);
    anom_status_t (ANOM_CALL *predict_batch)(
        anom_yolo_t* self, const anom_image_t* images, size_t image_count, anom_prediction_t* out_predictions);
};
